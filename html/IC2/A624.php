...
<html lang="fr">
    ...
    <body>
        ...
        <main id="salles">
            <h1 class="texte_droite">Salle A624</h1>
            <h5 class="texte_droite">
                <ul>
                    <li>10 places</li>
                    <li>3 tableaux</li>
                    <li>9 prises</li>
                    <li>Pas de rétroprojecteur</li>
                </ul>
            </h5>
            <img class="img_gauche" src="../../images/IC2_A624_front.jpg" alt="Salle A624">
